...
<body>
    <div class="container-fluid" style="width:90%">
        ...
        <div class="row" id="Login1">
            ...
            <div class="login2"  style=" text-align: center;text-align: justify;">

                <div class="container-fluid" id="Login" >
                    
                     
                  
                     <p class="here1">Sign Up for better overall Information</p>
                    
                    
                         <form action="" method="POST">
                         <h2 class="here">Log In Here:</h2>
                         <P>username is name entered while signup</P>
                             <tr>
                             ...
                             <br>
                             <button class="btn-success" name="submit" value="login">Login</button>
                            </form>
                             </div>
            </div>
